  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        <p>
          Eine Nutzung der Internetseiten der Computer AG ist grundsätzlich ohne
          jede Angabe personenbezogener Daten möglich. Sofern eine betroffene
          Person besondere Services der Internetseite in Anspruch nehmen möchte,
        ...
        <p>
          ...
          und in Übereinstimmung mit den für die Computer AG geltenden
          landesspezifischen Datenschutzbestimmungen. Ferner werden betroffene
          Personen mittels dieser Datenschutzerklärung über die ihnen
          zustehenden Rechte aufgeklärt.
        </p>
        <p>
          Die Computer AG hat als für die Verarbeitung Verantwortlicher
        ...
        <p>
          Die Datenschutzerklärung der Computer AG beruht auf den
        ...
        <p>
          Die Internetseite der Computer AG erfasst mit jedem Aufruf der
        ...
        <p>
          ...
          Computer AG keine Rückschlüsse auf die betroffene Person. Diese
          ...
          anonym erhobenen Daten und Informationen werden durch die Computer AG
        ...
        <h2>4. Registrierung auf unserer Internetseite</h2>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              bei der Computer AG gespeichert sind, veranlassen möchte, kann sie
              sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Computer
              AG wird veranlassen, dass dem Löschverlangen unverzüglich
              nachgekommen wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten von der Computer AG öffentlich
              gemacht und ist unser Unternehmen als Verantwortlicher gemäß Art.
              17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
              verpflichtet, so trifft die Computer AG unter Berücksichtigung der
              ...
              Computer AG wird im Einzelfall das Notwendige veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              Daten, die bei der Computer AG gespeichert sind, verlangen möchte,
              kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Computer
          ...
          <li>
            ...
            <p>
              ...
              die betroffene Person jederzeit an einen Mitarbeiter der Computer
              AG wenden.
            </p>
          </li>
          <li>
            ...
            <p>
              Die Computer AG verarbeitet die personenbezogenen Daten im Falle
            ...
            <p>
              Verarbeitet die Computer AG personenbezogene Daten, um
              ...
              Person gegenüber der Computer AG der Verarbeitung für Zwecke der
              Direktwerbung, so wird die Computer AG die personenbezogenen Daten
            ...
            <p>
              ...
              Verarbeitung personenbezogener Daten, die bei der Computer AG zu
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter der Computer AG oder einen
          ...
          <li>
            ...
            <p>
              ...
              Computer AG angemessene Maßnahmen, um die Rechte und Freiheiten
