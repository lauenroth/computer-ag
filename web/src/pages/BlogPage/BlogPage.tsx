...
const BlogPage = () => {
  return (
    <>
      <MetaTags title="Blog | Computer AG" />
      <MainLayout isMaxWidth maxWidth="wider">
        ...
        <Wrapper>
          <div>
            <h1>Unser Blog</h1>
            <p>
              Hier findet ihr kurze Zusammenfassungen der Themen, die wir in der
              Computer AG besprochen haben:
            </p>
            <List>
              <li>
                <a href="/blog/los-gehts">18.1. - Los geht&#39;s!</a>
              </li>
              {/* <li>
